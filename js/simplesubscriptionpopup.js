;(function ( $, window, document, undefined ) {
	...
	$.extend( Plugin.prototype, {
		...
		var contenttitle = tit;
			if ( isImage( options.media ) ) {
				...
				var youtubeurl = 'http://www.youtube.com/embed/' + options.media + '?version=3&rel=0&autoplay=0&wmode=transparent';
	...
	/*						Email Validation Function			*/
		...
		if ( fontstoappend != "" ) {
				if ( !jQuery( "link[href='https://fonts.googleapis.com/css?family=" + fontstoappend + "']" ).length ) {
					jQuery( 'head' ).append( '<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=' + fontstoappend + '" type="text/css" />' );
				}
		}
		if ( !jQuery( "link[href='https://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css']" ).length ) {
			jQuery('head').append('<link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" type="text/css" />');
		}
